# germini-ai-vendor
AI Vending Machine API for the Arc Hackathon. A micropayment-powered API that sells AI answers for USDC.
# AI Vending Machine 🤖🛒
...
# Clone repository
git clone
(https://github.com/Sule-Bashir/germini-ai-vendor)
cd germini-ai-vendo
...
2. Making a Payment & Accessing Content
